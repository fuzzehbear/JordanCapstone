...
if(isset($_POST["submitted"])){
  ...
  // $data = array(
  //   'secret' => '6LeLm04UAAAAAJTJ0V09w61GJvsxLvtEMgJq0Nvg',
  //   'response' => $_POST["g-recaptcha-response"]);
  // $options = array(
  //   'http' => array (
  //     'method' => 'POST',
...
<table border='0' width="100%">
  ...
  <tr>    
    <td>Password</td>
    <td><input type="password" name="password" required  value="<?=$password?>"  size="30"></td>
...
<!-- <div class="captcha_wrapper">
    <div class="g-recaptcha" data-sitekey="6LeLm04UAAAAAIPErCs3p0cIQNPh3273eSkQ2HPr"></div>
  </div> -->
</td>
